...
- Matthew Palmer
  - Edited and refined initial proposal
  - Edited and corrected areas of the ER diagram. Came up with my own ER diagram based off of Chris's.
  - Edited SQL scripts for deliverable 3
  - Further refined the ER diagram based on feedback for deliverable 3
  - Scaffolded out initial source code for deliverable 4
  - Populated Service methods including:
    - createBounty()
    - deleteBountyIfNotCompleted()
    - claimBounty()
    - setCompleted()
